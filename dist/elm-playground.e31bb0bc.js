...
var $author$project$Main$GotTopMsg = function (a) {
	return {$: 'GotTopMsg', a: a};
};
var $author$project$Main$TopModel = function (a) {
	return {$: 'TopModel', a: a};
};
var $author$project$Pages$Top$TopModel = {$: 'TopModel'};
var $author$project$Pages$Top$init = function (msg) {
	return _Utils_Tuple2($author$project$Pages$Top$TopModel, msg);
};
...
var $author$project$Main$init = function (_v0) {
	return A3(
		...
		$author$project$Main$TopModel,
		$author$project$Main$GotTopMsg,
		$author$project$Pages$Top$init($elm$core$Platform$Cmd$none));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$GotMultiHttpRequestMsg = function (a) {
	return {$: 'GotMultiHttpRequestMsg', a: a};
};
var $author$project$Main$MultiHttpRequestModel = function (a) {
	return {$: 'MultiHttpRequestModel', a: a};
};
var $author$project$Pages$MultiHttpRequest$init = function (msg) {
	return _Utils_Tuple2(
		{results: _List_Nil},
		msg);
};
var $author$project$Main$changePageTo = function (page) {
	if (page.$ === 'Top') {
		return A3(
			$author$project$Main$updateWith,
			$author$project$Main$TopModel,
		...
		return A3(
			$author$project$Main$updateWith,
			$author$project$Main$MultiHttpRequestModel,
			$author$project$Main$GotMultiHttpRequestMsg,
			$author$project$Pages$MultiHttpRequest$init($elm$core$Platform$Cmd$none));
	}
};
var $author$project$Pages$MultiHttpRequest$GotSequential = function (a) {
	return {$: 'GotSequential', a: a};
};
...
var $author$project$Pages$MultiHttpRequest$GotParallel = function (a) {
	return {$: 'GotParallel', a: a};
};
...
var $author$project$Pages$MultiHttpRequest$jsonResolver = $elm$http$Http$stringResolver(
	function (response) {
		switch (response.$) {
			case 'BadUrl_':
				var url = response.a;
			...
			case 'Timeout_':
				return $elm$core$Result$Err('Request Timeout');
			case 'NetworkError_':
...
var $author$project$Pages$MultiHttpRequest$requestGet = function (url) {
	return $elm$http$Http$task(
		{body: $elm$http$Http$emptyBody, headers: _List_Nil, method: 'GET', resolver: $author$project$Pages$MultiHttpRequest$jsonResolver, timeout: $elm$core$Maybe$Nothing, url: url});
};
var $author$project$Pages$MultiHttpRequest$requestParallel = function () {
	...
	return $elm$core$Platform$Cmd$batch(
		_List_fromArray(
			[
				A2($elm$core$Task$attempt, $author$project$Pages$MultiHttpRequest$GotParallel, request1),
				A2($elm$core$Task$attempt, $author$project$Pages$MultiHttpRequest$GotParallel, request2),
				A2($elm$core$Task$attempt, $author$project$Pages$MultiHttpRequest$GotParallel, request3),
				A2($elm$core$Task$attempt, $author$project$Pages$MultiHttpRequest$GotParallel, request4)
			]));
}();
var $elm$core$Debug$log = _Debug_log;
var $author$project$Pages$MultiHttpRequest$requestSequential = function () {
	var request4 = $author$project$Pages$MultiHttpRequest$requestGet('https://binaryjazz.us/wp-json/genrenator/v1/genre/');
	...
	var request2 = function (b) {
		...
		return $author$project$Pages$MultiHttpRequest$requestGet('https://data.ripple.com/v2/ledgers/');
	};
	var request1 = $author$project$Pages$MultiHttpRequest$requestGet('https://dog.ceo/api/breeds/image/random');
...
var $author$project$Pages$MultiHttpRequest$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'RequestSequential':
				return _Utils_Tuple2(
					{results: _List_Nil},
					A2($elm$core$Task$attempt, $author$project$Pages$MultiHttpRequest$GotSequential, $author$project$Pages$MultiHttpRequest$requestSequential));
			case 'GotSequential':
				var result = msg.a;
				if (result.$ === 'Ok') {
			...
			case 'RequestParallel':
				return _Utils_Tuple2(
					{results: _List_Nil},
					$author$project$Pages$MultiHttpRequest$requestParallel);
			case 'GotParallel':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var response = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								results: A2($elm$core$List$cons, response, model.results)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var e = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								results: A2($elm$core$List$cons, e, model.results)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
	...
	function (msg, model) {
		...
		while (true) {
			switch (_v0.a.$) {
				case 'ChangePage':
					var page = _v0.a.a;
					return $author$project$Main$changePageTo(page);
				case 'GotTopMsg':
					if (_v0.b.$ === 'TopModel') {
						var subMsg = _v0.a.a;
						var page = subMsg.a;
				...
				default:
					if (_v0.b.$ === 'MultiHttpRequestModel') {
						var subMsg = _v0.a.a;
						var subModel = _v0.b.a;
						if (subMsg.$ === 'ChangePage') {
							var page = subMsg.a;
							return $author$project$Main$changePageTo(page);
						} else {
							return A3(
								...
								$author$project$Main$MultiHttpRequestModel,
								$author$project$Main$GotMultiHttpRequestMsg,
								A2($author$project$Pages$MultiHttpRequest$update, subMsg, subModel));
						}
					} else {
						break _v0$3;
					}
...
var $author$project$Pages$MultiHttpRequest$ChangePage = function (a) {
	return {$: 'ChangePage', a: a};
};
var $author$project$Pages$MultiHttpRequest$RequestParallel = {$: 'RequestParallel'};
var $author$project$Pages$MultiHttpRequest$RequestSequential = {$: 'RequestSequential'};
var $author$project$Page$Top = {$: 'Top'};
var $author$project$Pages$MultiHttpRequest$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Pages$MultiHttpRequest$ChangePage($author$project$Page$Top))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('戻る')
							]))
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Pages$MultiHttpRequest$RequestSequential)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Sequential')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Pages$MultiHttpRequest$RequestParallel)
					]),
				_List_fromArray(
					[
...
var $author$project$Pages$Top$ChangePage = function (a) {
	return {$: 'ChangePage', a: a};
};
var $author$project$Page$MultiHttpRequest = {$: 'MultiHttpRequest'};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Pages$Top$ChangePage($author$project$Page$MultiHttpRequest))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Multiple Http Request')
					]))
			]));
};
var $author$project$Main$view = function (model) {
	if (model.$ === 'TopModel') {
		...
		return A2(
			$elm$html$Html$map,
			$author$project$Main$GotTopMsg,
			$author$project$Pages$Top$view(subModel));
	} else {
		var subModel = model.a;
		return A2(
			$elm$html$Html$map,
			$author$project$Main$GotMultiHttpRequestMsg,
			$author$project$Pages$MultiHttpRequest$view(subModel));
	}
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Pages.MultiHttpRequest.ErrorMessage":{"args":[],"type":"String.String"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangePage":["Page.Page"],"GotTopMsg":["Pages.Top.Msg"],"GotMultiHttpRequestMsg":["Pages.MultiHttpRequest.Msg"]}},"Pages.MultiHttpRequest.Msg":{"args":[],"tags":{"ChangePage":["Page.Page"],"RequestSequential":[],"GotSequential":["Result.Result Pages.MultiHttpRequest.ErrorMessage (List.List String.String)"],"RequestParallel":[],"GotParallel":["Result.Result Pages.MultiHttpRequest.ErrorMessage String.String"]}},"Pages.Top.Msg":{"args":[],"tags":{"ChangePage":["Page.Page"]}},"Page.Page":{"args":[],"tags":{"Top":[],"MultiHttpRequest":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
//# sourceMappingURL=/elm-playground.e31bb0bc.js.map